(function () {
  ...
  const catalogs = [
    { key: "palprints-tshirt-favorites", page: "tshirts.html", items: [
      ["flower-good-day", "تيشيرت أطفال", "يوم سعيد", "Lina A.", 20, "assets/images/tshirts/kids-flower-good-day.png"], ["panda-music", "تيشيرت أطفال", "موسيقى دائماً", "Omar K.", 20, "assets/images/tshirts/kids-panda-music.png"], ["little-explorer", "تيشيرت أطفال", "للمستكشف الصغير", "Sara N.", 20, "assets/images/tshirts/kids-little-explorer.png"], ["moon-good-day", "تيشيرت رجال / نساء", "يوم جيد دائماً", "Ahmad Z.", 20, "assets/images/tshirts/adults-good-day.png"], ["good-things", "تيشيرت رجال / نساء", "الأمور الجيدة تستغرق وقتاً", "Haneen S.", 20, "assets/images/tshirts/adults-good-things.png"]
    ]},
