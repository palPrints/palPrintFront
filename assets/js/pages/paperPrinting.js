...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function formatMoney(amount) {
    ...
    return new Intl.NumberFormat(locale, { style: "currency", currency: "SAR", minimumFractionDigits: 2 }).format(amount || 0);
  }
  ...
  function updateSummary() {
    ...
    $("span", el.mobileCta).textContent = t(ctaKeys[state.currentStep]);
    const mobileCtaIcon = $("i", el.mobileCta);
    mobileCtaIcon.className = state.currentStep === 4 ? "bi bi-cart-plus" : "bi bi-arrow-left";
  }
